...
class TestTruncationRecoveryMessageModification:
    ...
    def _force_truncation_recovery_enabled(self):
        """Force truncation recovery on to keep tests deterministic."""
        with patch(
            "kiro.truncation_recovery.should_inject_recovery", return_value=True
        ):
            yield
